...
export const metadata: Metadata = {
  title: "Next.js Buttons | Solaris CRM - Next.js Dashboard Template",
  description:
    "This is Next.js Buttons page for Solaris CRM - Next.js Tailwind CSS Admin Dashboard Template",
};
