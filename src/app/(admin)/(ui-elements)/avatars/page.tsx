...
export const metadata: Metadata = {
  title: "Next.js Avatars | Solaris CRM - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for Solaris CRM - Next.js Tailwind CSS Admin Dashboard Template",
};
